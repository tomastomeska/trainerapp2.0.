...
CREATE TABLE IF NOT EXISTS `coach_meal_plan_items` (
    ...
    FOREIGN KEY (`meal_plan_id`) REFERENCES `coach_meal_plans`(`id`) ON DELETE CASCADE,
    FOREIGN KEY (`meal_id`) REFERENCES `coach_meals`(`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `athlete_meal_plans` (
    ...
    FOREIGN KEY (`athlete_id`) REFERENCES `athletes`(`id`) ON DELETE CASCADE,
    FOREIGN KEY (`meal_plan_id`) REFERENCES `coach_meal_plans`(`id`) ON DELETE CASCADE,
    FOREIGN KEY (`removed_by_coach_id`) REFERENCES `coaches`(`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
